        ...
        <div class="modal-content">
            ...
            <form  id="frm-update-vehicle" role="form" action="">
                <div class="modal-body">
                    <input type="hidden" id="vehicle_id_edit" name="vehicle_id">
                    <label for="vehicle-number">Vehicle Number</label>
                    <div class="row">
                        <div class="col-sm-12">
                            <input type="text" name="vehicle_number" id="vehicle-number" class="form-control">
                        </div>
                    </div>
                    <br>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <select class="form-control" name = "station_id" id = "station_id_edit">
                                <option value="">---------------</option>
